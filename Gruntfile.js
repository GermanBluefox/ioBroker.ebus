...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (fs.existsSync(__dirname + '/admin/ebus.png')) {
            fs.renameSync(__dirname + '/admin/ebus.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/ebus.html')) {
            fs.renameSync(__dirname + '/widgets/ebus.html',           __dirname + '/widgets/' + newname + '.html');
        }
